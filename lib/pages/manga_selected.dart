...
class MangaSelectedPage extends StatelessWidget {
          ...
          children: [
            ...
            Expanded(
              child: favoriteProvider.favoriteItems.isEmpty
                  ...
                  : _buildFavoriteMangaGrid(context, favoriteProvider, isMobile),
            ),
          ],
        ),
      ),
  ...
  Widget _buildFavoriteMangaGrid(BuildContext context, FavoriteProvider favoriteProvider, bool isMobile) {
    return GridView.builder(
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
        crossAxisCount: isMobile ? 1 : 2, // Один столбец на мобильных устройствах, два на десктопах
        childAspectRatio: 1.7, // Соотношение ширины и высоты
      ...
      itemBuilder: (context, index) {
        ...
        return _buildMangaCard(context, manga, index, favoriteProvider);
      },
    );
  }

  Widget _buildMangaCard(BuildContext context, MangaItem manga, int index, FavoriteProvider favoriteProvider) {
    final screenWidth = MediaQuery.of(context).size.width;
    final isMobile = screenWidth < 600;
